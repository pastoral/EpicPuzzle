...
#region detectors examples
		...
		{
			logBuilder.Length = 0;
			logBuilder.AppendLine(CodeStage.AntiCheat.Common.Constants.LOG_PREFIX + "<b>[ ObscuredString test ]</b>");
		...
		{
			logBuilder.Length = 0;
			logBuilder.AppendLine(CodeStage.AntiCheat.Common.Constants.LOG_PREFIX + "<b>[ ObscuredInt test ]</b>");
		...
		{
			logBuilder.Length = 0;
			logBuilder.AppendLine(CodeStage.AntiCheat.Common.Constants.LOG_PREFIX + "<b>[ ObscuredFloat test ]</b>");
		...
		{
			logBuilder.Length = 0;
			logBuilder.AppendLine(CodeStage.AntiCheat.Common.Constants.LOG_PREFIX + "<b>[ ObscuredVector3 test ]</b>");
